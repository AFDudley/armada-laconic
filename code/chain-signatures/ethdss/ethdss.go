...
func (d *DSS) Index() int {
	return d.index
}

// Participants returns the list of participant public keys.
func (d *DSS) Participants() []kyber.Point {
	return d.participants
}

// SessionID returns the signature's unique session ID, shared by all participants.
func (d *DSS) SessionID() []byte {
	return d.sessionID
}

// Message returns the message to be signed.
func (d *DSS) Message() *big.Int {
	return d.msg
}
