...
- **Reuse vs build:** config — the T0.0 net-new pool (Railgun-spec-compatible) already holds multi-asset notes (wstETH), so this is note-config integration with no new contract.
